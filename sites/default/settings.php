<?php
    ...
    $server = new \lillockey\Utilities\App\Access\ArrayAccess\ServerArray();
	$host = $server->getHost();

	if (strpos($host, 'gff.beta04.ascedia.com') !== FALSE) {
		// Beta Connection
		$databases = array('default' => array('default' => array(
			'database' => 'gffbeta_BetaSite',
			'username' => 'gffbeta_sql',
			'password' => '4&v9R7}-,^E#',
			'host' => 'localhost',
			'port' => '',
			'driver' => 'mysql',
        ...
        define('USING__UTILITIES_LOG', false);

	} elseif (strpos($host, 'chris.geriatricfastfacts.com') !== FALSE) {
        // Chris - local development
        //TODO: delete this after finished debugging
        require __DIR__ . '/../../includes/krumo/class.krumo.php';

        $databases = array('default' => array('default' => array(
            'database' => 'aurora__geriatric_facts',
            'username' => 'root',
            'password' => null,
            'host' => 'localhost',
            'port' => '',
        ...
        define('USING__UTILITIES_LOG', true);

    }elseif (strpos($host, 'geriatricfastfacts.com') !== FALSE) {
		// Live Connection
		$databases = array('default' => array('default' => array(
			'database' => 'geriatri_MainSiteBackup',
			'username' => 'geriatri_FstFcts',
			'password' => 'c4QjJaYXCQywGGpW',
			'host' => 'localhost',
			'port' => '',
			'driver' => 'mysql',
			'prefix' => '',
...
\lillockey\Utilities\App\InstanceHolder::set_config(new \lillockey\Utilities\Config\FullCustomConfig(
	 ...
	 *
	 */
	$drupal_hash_salt = 'vaik-bCymJo2fDLvBnbfsibVeI7FzifWvCNNYlpA43c';
